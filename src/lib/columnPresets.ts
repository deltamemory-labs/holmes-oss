export type ColumnFormat = "text" | "bulleted_list" | "number" | "percentage" | "monetary_amount" | "currency" | "yes_no" | "date" | "tag";
...
export const PROMPT_PRESETS: ColumnPreset[] = [
  ...
  },
  {
    ...
    format: "text",
    prompt: "Identify and describe key representations and warranties provided by any party, including the scope of such assurances and any specific time periods or conditions applicable to them.",
  },
  {
    name: "Force Majeure",
...
export const PRACTICE_OPTIONS = [
  "General Transactions", "Corporate", "Finance", "Litigation",
  "Real Estate", "Tax", "Employment", "IP", "Competition",
  "Tech Transactions", "Project Finance", "EC/VC", "Private Equity",
  "Private Credit", "ECM", "DCM", "Lev Fin", "Arbitration", "Others",
] as const;

export type Practice = (typeof PRACTICE_OPTIONS)[number];

export function getPresetConfig(title: string): Pick<ColumnPreset, "prompt" | "format" | "tags"> | null {
